...
def User_Choice():
    ...
    Bu1.place(x=20,y=50)
    Bu2=Button(T,text="2. CHECK WEITHER LOCATION IS SUITABLE",command=lambda:[des(),review()],bg="#7FFFD4",font=("Algerian",15),bd=5,activebackground="#00BFFF")
    Bu2.place(x=60,y=110)
    Bu3=Button(T,text="3. PUBLIC TRANSPORTATION ANALYSIS IN AREA",command=lambda:[des(),transport()],
